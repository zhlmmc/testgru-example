...
describe('UserManager', () => {
  ...
  describe('deleteUserByName', () => {
    ...
    it('should delete only first user with matching name', () => {
      userManager.addUser('John', 'john1@example.com');
      userManager.addUser('John', 'john2@example.com');
